...
import { addProduct, IcartItems, minusProduct, removeProduct } from '../redux/slices/cartSlice';
import React from 'react';

const CartItem: React.FC<IcartItems> = ({ id, imageUrl, title, type, size, price, count }) => {
